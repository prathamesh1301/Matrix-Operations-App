...
public class Matrix_Add_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b=new ArrayList<>();
        a=new ArrayList<>();
        ansButton=findViewById(R.id.addButton);
        ...
        ansButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(storeDataInArrays()){
                    Intent intent=new Intent(Matrix_Add_Activity.this,AddActivity.class);
                    Bundle bd=new Bundle();
                    bd.putSerializable("matrixA",matrixA);
                    bd.putSerializable("matrixB",matrixB);
                    intent.putExtras(bd);
    ...
    public boolean storeDataInArrays(){
        ...
        for(int i=0;i<9;i++){    //get values from A to list bvals
            ...
            if(TextUtils.isEmpty(s)){
                Toast.makeText(Matrix_Add_Activity.this, "Fill the fields", Toast.LENGTH_SHORT).show();
                return false;
            }
